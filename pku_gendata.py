...
if __name__ == '__main__':
    ...
    # parser.add_argument('--data_path', default='../data/PKU-MMD/v1/')
    # parser.add_argument('--out_folder', default='../data/PKU-MMD-v1-AGCN/')
    # benchmark = ['xsub','xview', ]

    parser.add_argument('--data_path', default='../data/PKU-MMD/v2/')
